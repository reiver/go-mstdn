...
//				`"emojis":[]`+
...

		{
			Account: ent.Account{
				...
				HeaderStatic:  opt.Something("https://files.example.com/header-static/joeblow.png"),
				Fields:        []ent.Field{
					ent.FieldNameValue("alt", "@joeblow@greatape.social"),
				},
				//Emojis
				Locked:         opt.Something(false),
				Bot:            opt.Something(false),
...
//				`"emojis":[]`+
...

		{
			Account: ent.Account{
				...
				Fields:        []ent.Field{
					ent.FieldNameValue("alt", "@joeblow@greatape.social"),
					ent.FieldVerifiedNameValue("2022-09-29T08:41:46Z", "alt (long-form)", "@joeblow@postfreely.social"),
				},
				//Emojis
				Locked:         opt.Something(false),
				Bot:            opt.Something(false),
...
//				`"roles":[]`+
...

		{
			Account: ent.Account{
				...
				Roles: []ent.Role{
					ent.Role{
						ID: opt.Something(jsonint.NumericFromInt64(15)),
						Name: opt.Something("sponsor (PostFreely)"),
						Color: opt.Something("#ff2400"),
						Permissions:  opt.Something(jsonint.NumericFromInt64(0)),
...

		{
			Account: ent.Account{
				...
				Roles: []ent.Role{
					...
					ent.Role{
						ID: opt.Something(jsonint.NumericFromInt64(28)),
						Name: opt.Something("sponsor (Firefish)"),
						Color: opt.Something("#30ff11"),
						Permissions:  opt.Something(jsonint.NumericFromInt64(255)),
...

		{
			Account: ent.Account{
				...
				Roles: []ent.Role{
					...
					ent.Role{
						ID: opt.Something(jsonint.NumericFromInt64(1)),
