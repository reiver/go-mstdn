...
type Status struct {
	...
	ReblogsCount       opt.Optional[jsonint.Numeric] `json:"reblogs_count,omitempty"`
	FavouritesCount    opt.Optional[jsonint.Numeric] `json:"favourites_count,omitempty"`
	RepliesCount       opt.Optional[jsonint.Numeric] `json:"replies_count,omitempty"`
